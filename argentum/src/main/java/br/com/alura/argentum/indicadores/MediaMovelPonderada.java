...
public class MediaMovelPonderada implements Indicador {
	...
	private Indicador outroIndidado = new IndicadorFechamento();

	public MediaMovelPonderada() {
	}

	public MediaMovelPonderada(Indicador outroIndicador) {
		this.outroIndidado = outroIndicador;
	}
	...
	public double calcula(int posicao, SerieTemporal serie) {
		...
		for (int i = posicao; i > posicao - 3; i--) {
			soma += outroIndidado.calcula(i, serie) * peso;
			peso--;
		}
		return soma / 6;
	}
	...
	public String toString() {
		return "MMP de " + outroIndidado.toString();
	}
